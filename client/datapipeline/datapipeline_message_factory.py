...
'''
This file is used for automated testing of the data pipeline client
...
class SimplewalletMessageFactory(object):
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            ...
            family_version="1.0",
            namespace=MessageFactory.sha512("DataPipeline".encode("utf-8"))[0:6],
            signer=signer)
    ...
    def _make_address(self):
        return self._factory.namespace + self._factory.sha512(self._factory.get_public_key())[0:64]
    ...
    def _create_txn(self, txn_function, action, value=None):
        payload = ",".join(list(str(action), str(value))).encode()
